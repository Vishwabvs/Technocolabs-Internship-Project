...
#unmasked_dir = '/home/vishwa/Documents/COVID Project/Technocolabs-Intern-Project/Transfer Learning/Unmasked_Faces'
...
class util:
	...
	def findandret(frame):
		...
		for (box, pred) in zip(locs, preds):
			...
			if label == 'No Mask':
				print('hi')
				cv2.imwrite(os.path.join(str(i)+'.jpg'), frame[startY:endY, startX:endX])
